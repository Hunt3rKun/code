...
def Love():
    ...
    love.title("")
    label = Label(love, text = "我就知道你会同意的^-^", font = ("华文中宋", 15))
    label.pack()
...
def noLove():
    ...
    no_love.title("")
    if a == 1:
        label = Label(no_love, text = "我妈会游泳", font = ("华文中宋", 15))
        label.pack()
        btn = Button(no_love, text = "好的", width = 10, height = 2, command = no_love.destroy)
        btn.pack()

    if a == 2:
        label = Label(no_love, text = "保大", font = ("华文中宋", 15))
        label.pack()
        btn = Button(no_love, text = "好的", width = 10, height = 2, command = no_love.destroy)
        btn.pack()

    if a == 3:
        label = Label(no_love, text = "房产写你名字", font = ("华文中宋", 15))
        label.pack()
        btn = Button(no_love, text = "好的", width = 10, height = 2, command = no_love.destroy)
        btn.pack()
...
# 标签控制
label = Label(window, text = "罗颖，\n我观察你很久了\n做我女朋友好不好", font = ("华文中宋", 15),  justify = LEFT, padx = 10)
...
# 显示图片
photo = PhotoImage(file = "nosebleed.jif")
